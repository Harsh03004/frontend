...
import EditProfileModal from "../components/EditProfileModal"; // 1. Import the new modal component
...
function Profile() {
  ...
  const [isModalOpen, setIsModalOpen] = useState(false); // 2. Add state to control the modal
  ...
  return (
      <>
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
              ...
              <div className="col-span-full">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {/*<button onClick={() => setIsModalOpen(true)} className="text-sm text-indigo-400 hover:underline">*/}
                  {/*  change Email*/}
                  {/*</button>*/}
                </div>
              </div>
        ...
        {isModalOpen && <EditProfileModal user={id} onClose={() => setIsModalOpen(false)} />}
      </>
  );
}
