...
// //               onClick={() => navigate(`/organisation/${org._id}/classes`)} // Navigate to classes page
// //             >
...
// const Organisation = () => {
//   const { fetchOrganisations, createOrganisation } = useContext(organisationContext);
//   const { fetchClasses } = useContext(ClassesContext); // Use fetchClasses from ClassesContext
//   const [organisations, setOrganisations] = useState([]);
//   const [loading, setLoading] = useState(false);
//   const [error, setError] = useState(null);
//   const [newOrgName, setNewOrgName] = useState("");
...
//   // Handle fetching classes for a specific organisation
//   const handleFetchClasses = (organisationId) => {
//     fetchClasses(organisationId); // Trigger fetching classes based on organisation ID
//   };
...
//               key={org._id || index}
//               className="card bg-base-100 shadow-md hover:shadow-lg transition-shadow cursor-pointer"
//               onClick={() => handleFetchClasses(org._id)} // Fetch classes when clicked
//             >
//               <div className="card-body">
//                 <h2 className="card-title">{org.name || "Untitled"}</h2>
//                 <p>{org.description || "No Description Available"}</p>
